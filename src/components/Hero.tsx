          ...
          <div className="text-center sm:text-left space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center sm:justify-start">
              <button 
                ...
                className="px-8 py-3 bg-amber-600 text-gray-900 font-semibold rounded-lg hover:bg-amber-700 transition-colors"
              >
                View My Work
              </button>
              <button 
                onClick={() => scrollToSection('contact')}
                className="px-8 py-3 border border-gray-600 text-gray-300 font-semibold rounded-lg hover:border-amber-600 hover:text-amber-600 transition-colors"
              >
                Get In Touch
              </button>
            </div>
